...
// Apply filters (but only allow filtering within verified applications)
if (!empty($statusFilter)) {
    // Committee can only see verified, so ignore status filter or enforce verified
    // We'll keep it simple and just show verified
}
                ...
                ?>
                    <div class="application-card" data-application-id="<?php echo $app['id']; ?>">
                        ...
                        <div class="verification-info">
                            <strong>✓ Verified Application</strong>
