...
<body>
    ...
    <div class="dashboard-header">
        <div class="dashboard-content">
            <h1>Welcome back, <?php echo htmlspecialchars($committeeName); ?>!</h1>
            <p>Review and manage financial aid applications</p>
        </div>
    </div>
            ...
            <div class="dashboard-section">
                ...
                <div class="committee-info">
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo htmlspecialchars($committeeName); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Email</div>
                        <div class="info-value"><?php echo htmlspecialchars($committeeEmail); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Role</div>
                        <div class="info-value">Committee Member</div>
                    </div>
                </div>
            </div>
